            ...
            <div class="desktop1-topnavbar">
              <div class="desktop1-navbar1">`
                ...
                <div style="padding: 10px 20px;">
                  ...
                  <input name="search" type="text"  placeholder="Type something...">
                  <input style = "border:1px solid black; background:#FF6F61;" type="submit" name="submit">
                  </form>
                </div>

                <div style="padding: 1px 10px; margin-left:70px; font-size:18px; font-family:Arial, Helvetica, sans-serif; font-weight: bold;">
                <?php 
                if($Email != ""){
